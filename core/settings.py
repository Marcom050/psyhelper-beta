...
class Settings:
    ...
    consent_version:str; privacy_policy_version:str; terms_version:str; consent_enforcement_enabled:bool; data_export_enabled:bool; beta_trial_days:int; commercial_gating_enabled:bool
    @property
